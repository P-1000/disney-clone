...
//   return (
//     <div className="relative mx-auto py-8 px-2 w-full max-w-7xl bg-white">
...
//         {/* :COLLECTIONS */}
//         <div className="mt-10 grid lg:grid-rows-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:grid-flow-col gap-x-8">
//           {ranking.map(collection => (
//             <a href={collection.href} key={collection.rank} className="py-5 px-3 flex items-center border-b border-gray-200 hover:shadow-lg">
//               {/* ::Rank */}
//               <span className="mr-2 text-lg text-black font-bold">{collection.rank}</span>
//               {/* ::Details */}
...
//                     <img src={collection.collectionImg} alt="" className="w-full h-full" />
//                   </span>
...
//                   <p className="text-base text-gray-700 font-bold truncate">{collection.name}</p>
...
//                     <span className="text-sm text-gray-400 font-bold">{collection.floorPrice}</span>
//                   </p>
//                 </div>
//               </div>
//               {/* :::stats & total price */}
...
//                   <span className="text-sm text-gray-400 font-bold">{collection.totalValue}</span>
//                 </span>
//               </div>
//             </a>
//           ))
...
//         {/* :GO TO RANKINGS */}
//         <a href="#link" className="relative mt-10 inline-flex items-center px-5 py-2.5 rounded border border-transparent bg-indigo-500 text-base text-white font-bold hover:bg-indigo-600" >Go to Rankings</a>
